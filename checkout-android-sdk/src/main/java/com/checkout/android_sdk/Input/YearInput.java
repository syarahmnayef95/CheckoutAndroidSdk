 ...
 */
public class YearInput extends androidx.appcompat.widget.AppCompatSpinner {
    ...
    private void populateYears() {
        ...
        for (int i = Calendar.getInstance(Locale.US).get(Calendar.YEAR); i < Calendar.getInstance().get(Calendar.YEAR) + 15; i++) {
            yearElements.add(String.valueOf(i));
        }

        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(mContext,
                R.layout.simple_spinner_item, yearElements);
