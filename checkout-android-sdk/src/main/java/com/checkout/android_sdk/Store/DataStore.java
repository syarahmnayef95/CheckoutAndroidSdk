...
public class DataStore {
    ...
    private String mCardYear = String.valueOf(Calendar.getInstance(Locale.US).get(Calendar.YEAR));
    ...
    public void cleanState() {
        this.mCardNumber = "";
        this.mCardMonth = "";
        this.mCardYear = String.valueOf(Calendar.getInstance(Locale.US).get(Calendar.YEAR));
        this.mCardCvv = "";
        this.mCvvLength = 4;
